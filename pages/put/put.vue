	...
	<view style="box-sizing: border-box;padding: 10px;">
		<view class="uni-textarea">
			...
			<view class="item d-flex flex-nowrap j-start">
				<view class="title">
					<!-- <image src="../../static/images/name.png" mode="widthFix" style="width:40rpx;margin-right:10rpx;"></image> -->
					商品名称：</view>
		...
		<view class="">
			<button type="default" style="background-color: #007AFF;color:#FFFFFF;margin-top:100upx;width:300upx;">发布</button>
		</view>
	</view>
</template>
